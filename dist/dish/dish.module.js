...
DishModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: dish_schema_1.Dish.name, schema: dish_schema_1.DishSchema }]),
            mongoose_1.MongooseModule.forFeature([{ name: specification_schema_1.Specification.name, schema: specification_schema_1.SpecificationSchema }]),
        ],
